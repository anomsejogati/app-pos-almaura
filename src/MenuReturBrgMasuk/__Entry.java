...
import Class.ReturBarangMasuk_Detail;
...
import MenuReturBrgMasuk.__List;
...
public class __Entry extends javax.swing.JFrame {
    ...
    private void LoadData(){
        try{
            ...
            HapusTabel();
            String sql = "select a.no_retur, a.kd_barang, b.nm_barang, a.jumlah, a.harga, (a.jumlah*a.harga) as subtotal from pos_retbrgmasukdet a, pos_barang b "
            ...
            _Cnn = null;
            _Cnn = getCnn.getConnection();
            sql = "select sum(a.jumlah*a.harga) from pos_retbrgmasukdet a, pos_barang b where a.kd_barang=b.kd_barang "
    ...
    private void ClearDetailTrans(){
        try{
            _Cnn = null;
            _Cnn = getCnn.getConnection();
            String sql = "select a.no_retur, a.kd_barang, b.nm_barang, a.harga, a.jumlah, (a.jumlah*a.harga) as subtotal from pos_retbrgmasukdet a, pos_barang b "
                    + "where a.kd_barang=b.kd_barang and a.no_retur='"+tNoRetur.getText()+"'";
            Statement stat = _Cnn.createStatement();
            ResultSet res = stat.executeQuery(sql);
            while(res.next()){
    ...
    private void initComponents() {
        ...
        tDistributor = new javax.swing.JTextField();
        ...
        tDistributor.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        tDistributor.setForeground(new java.awt.Color(51, 51, 51));
        tDistributor.setCaretColor(new java.awt.Color(240, 240, 240));
        tDistributor.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        tDistributor.setEnabled(false);
        ...
        jXTitledPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jXTitledPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jXTitledPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jXTitledPanel1Layout.createSequentialGroup()
                        .addComponent(tNoFaktur, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(42, 42, 42)
                        .addComponent(jLabel7, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(tDistributor, javax.swing.GroupLayout.PREFERRED_SIZE, 205, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jXTitledPanel1Layout.createSequentialGroup()
                        .addComponent(tNoRetur, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(jXTitledPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jXTitledPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jXTitledPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(tDistributor, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jXTitledPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(jLabel3)
        ...
        jLabel9.setText("Retur Barang Masuk");

        jLabel11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/onebit_58.png"))); // NOI18N

        jLabel8.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        jLabel8.setText("Form ini digunakan untuk input retur Barang Masuk, otomatis mengurangi jumlah stok barang");
    ...
    private void BtnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSaveActionPerformed
        ...
        try{
            ReturBarangMasuk_Detail xs = new ReturBarangMasuk_Detail();
    ...
    private void BtnCloseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCloseActionPerformed
        ...
        f = new MenuReturBrgMasuk.__List();
        f.LoadData();
        dispose();
        }
    ...
    private void btSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSaveActionPerformed
        ...
        try{
            ...
            Double total = Double.parseDouble(tTotal.getValue().toString());
                    ...
                    String sql = "select id_dis from pos_brgmasuk where no_faktur='"+tNoFaktur.getText()+"'";
                    _Cnn = null;
                    _Cnn = getCnn.getConnection();
                    ...
                    while(res.next()){
                    id_dis = res.getString(1);
                    }
               
                    String sqlinsert = "insert into pos_retbrgmasuk values ('"+no_retur+"','"+no_faktur+"', '"+id_dis+"', "
                        + " '"+t+"', '"+total+"')";
    ...
    private void tNoFakturActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tNoFakturActionPerformed
        ...
        try {
            ...
            _Cnn = null;
            _Cnn = getCnn.getConnection();
            String sql = "SELECT a.no_faktur, a.id_dis, b.nm_distributor FROM pos_brgmasuk a, pos_distributor b "
                    + "  WHERE a.id_dis=b.id_dis and a.no_faktur='"+tNoFaktur.getText()+"'";
    ...
    private javax.swing.JTextField tDistributor;
    ...
    private void ListProduct(){
        try{
            ...
            _Cnn = getCnn.getConnection();
            String sql = "" +
                    "   SELECT a.kd_barang, b.nm_barang " +
                    "   FROM pos_brgmasukdet a, pos_barang b where a.kd_barang=b.kd_barang and a.no_faktur='"+tNoFaktur.getText()+"'";
            Statement stat = _Cnn.createStatement();
            ResultSet res = stat.executeQuery(sql);
    ...
    private void deletedet(){
        ...
        try
      {
          String sql = "DELETE FROM pos_retbrgmasukdet WHERE no_retur='"+ kode1 +"' and kd_barang='"+kode2+"'";
          _Cnn = null;
                    _Cnn = getCnn.getConnection();
                Statement state = _Cnn.createStatement();
         ...
         String sqljumlah = "select jumlah from pos_retbrgmasukdet where no_retur='"+kode1+"' and kd_barang='"+kode2+"'";
         ...
         String sqlupdate1 = "update pos_retbrgmasukdet set jumlah='"+stok1+"' where no_retur='"+kode1+"' and kd_barang='"+kode2+"'";
         state.executeUpdate(sqlupdate);
